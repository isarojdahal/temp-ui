...
import { DEFAULT_SCORECARD_URL } from './api';

// The scorecard endpoints are mounted on the Risk Scorecard Generator FastAPI microservice.

export async function fetchScorecardRegistry(baseUrl = DEFAULT_SCORECARD_URL) {
...
export async function fetchScorecardVersions(baseUrl = DEFAULT_SCORECARD_URL, assessmentId, { domain, userId } = {}) {
...
export async function fetchScorecardVersion(baseUrl = DEFAULT_SCORECARD_URL, assessmentId, versionId, { domain, userId } = {}) {
...
export async function deleteScorecardVersions(baseUrl = DEFAULT_SCORECARD_URL, assessmentId, { domain, userId } = {}) {
...
export async function saveScorecard(baseUrl = DEFAULT_SCORECARD_URL, assessmentId, { domain, userId, document, editMetadata }) {
